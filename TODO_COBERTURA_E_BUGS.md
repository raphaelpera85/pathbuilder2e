...
- Limitação conhecida (não corrigida nesta rodada): o Tomo traz **treze classes que o catálogo não tem** — Duergar (p. 44, d6, máx 10), Drow (p. 38, d6, máx 10), Gnomo (p. 52, d4, máx 8), Meio-Elfo (p. 54, d6, máx 12), Meio-Orc (p. 60, d6, máx 8) e Svirfneblin (p. 72, d6, máx 8), além das classes avançadas propriamente ditas. Registrado como pendência, sem inventar tabelas.

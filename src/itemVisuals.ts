...
export function getItemVisualKey(data: ItemVisualData = {}): string {
  ...
  if (data.id === "item.rage_elements.wood.purifying_spoon" || /^colher purificadora$/.test(name)) return "purifying-spoon";
  ...
  if (data.id === "item.rage_elements.metal.zuhras_gloves" || /^luvas de zuhra$/.test(name)) return "zuhras-gloves";
  if (data.id === "item.pc2.smoke_ball" || /^bola de fuma[cç]a$/.test(name)) return "smoke-ball";
  if (data.id === "item.pc2.alarm_snare" || /^arapuca de alarme$/.test(name)) return "alarm-snare";
  if (data.id === "item.pc2.spike_snare" || /^arapuca de espinho$/.test(name)) return "spike-snare";
  if (data.id === "item.pc2.hunters_bane" || /^ru[ií]na do ca[cç]ador$/.test(name)) return "hunters-bane";
  ...
  if (data.id === "item.pc2.signaling_snare" || /^arapuca sinalizadora$/.test(name)) return "signaling-snare";

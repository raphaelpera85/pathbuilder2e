...
export const T20_ORIGINS: T20Origin[] = [
  ...
  origin("assistente_de_laboratorio", "Assistente de Laboratório", ["oficio_alquimia", "misticismo"], ["esse_cheiro", "veneficio", "poder_da_tormenta"], ["kit de ofício (alquimia)"]),
  ...
  origin("fazendeiro", "Fazendeiro", ["adestramento", "cavalgar", "oficio_fazendeiro", "sobrevivencia"], ["agua_no_feijao", "ginete"], ["ferramenta agrícola", "animal de fazenda"]),
  ...
  origin("minerador", "Minerador", ["atletismo", "fortitude", "oficio_minerador"], ["ataque_poderoso", "escavador", "sentidos_agucados"], ["gemas (T$ 100)", "picareta"]),
  ...
  origin("taverneiro", "Taverneiro", ["diplomacia", "jogatina", "oficio_culinaria"], ["gororoba", "proficiencia", "vitalidade"], ["rolo de macarrão ou martelo", "panela", "avental", "caneca"]),

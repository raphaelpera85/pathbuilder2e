...
export const T20_RACE_RULES: T20RaceRules[] = [
  ...
  r("lefou", "Lefou", 24, "+2 em três atributos diferentes (exceto Carisma), Carisma -2", { cha: -2 }, "Médio", 9, ["Criatura da Tormenta", "Deformidade: bônus em duas perícias ou poder da Tormenta"], { count: 3, amount: 2, exclude: ["cha"] }, 2, "tormenta"),

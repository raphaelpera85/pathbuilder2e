...
// Extended source type for multi-system books (T20, D&D 5e, OSE)
export interface MultiSystemSource extends PathfinderSource {
  system: "pf2e" | "t20" | "dnd5e" | "ose";
...
export const pathfinderSources: PathfinderSource[] = [
  ...
  {
    id: "ancestry-guide-pt",
    title: "Guia de Ancestralidades (Legacy)",
    titles: { "pt-BR": "Guia de Ancestralidades (Legacy)", en: "Ancestry Guide (Legacy)", es: "Guía de ascendencias (legado)" },
    language: "pt-BR",
    pages: 238,
    ruleset: "legacy",
    pageCountStatus: "verified_with_pdfinfo",
    ...
    filename: "LIVRO - Pathfinder - Guia de Ancestralidades.pdf",
    downloadUrl: GOOGLE_DRIVE_FOLDER_URL,
    viewUrl: GOOGLE_DRIVE_FOLDER_URL,
    driveUrl: GOOGLE_DRIVE_FOLDER_URL
  },
...
// Google Drive folder for T20, D&D 5e and OSE books (stored locally, no individual fileIds)
export const T20_DRIVE_FOLDER_URL = GOOGLE_DRIVE_FOLDER_URL;
...
export const multiSystemSources: MultiSystemSource[] = [
  // ─── Tormenta 20 ────────────────────────────────────────────────────────────
  {
    id: "t20-livro-base",
    system: "t20",
    systemLabel: { "pt-BR": "Tormenta20", en: "Tormenta20", es: "Tormenta20" },
    ...
    linkedRecords: 412,
    verifiedAt: "2026-09-21",
    filename: "Tormenta 20.pdf",
    downloadUrl: T20_DRIVE_FOLDER_URL,
    viewUrl: T20_DRIVE_FOLDER_URL,
    driveUrl: T20_DRIVE_FOLDER_URL
  },
  {
    id: "t20-ameacas-de-arton",
    system: "t20",
    systemLabel: { "pt-BR": "Tormenta20", en: "Tormenta20", es: "Tormenta20" },
    title: "Tormenta20 - Ameaças de Arton",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "Tormenta20 - Ameacas de Arton.pdf",
    downloadUrl: T20_DRIVE_FOLDER_URL,
    viewUrl: T20_DRIVE_FOLDER_URL,
    driveUrl: T20_DRIVE_FOLDER_URL
  },
  {
    id: "t20-atlas-de-arton",
    system: "t20",
    systemLabel: { "pt-BR": "Tormenta20", en: "Tormenta20", es: "Tormenta20" },
    title: "Tormenta20 - Atlas de Arton",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "Tormenta20 - Atlas de Arton.pdf",
    downloadUrl: T20_DRIVE_FOLDER_URL,
    viewUrl: T20_DRIVE_FOLDER_URL,
    driveUrl: T20_DRIVE_FOLDER_URL
  },
  {
    id: "t20-codice-de-poderes",
    system: "t20",
    systemLabel: { "pt-BR": "Tormenta20", en: "Tormenta20", es: "Tormenta20" },
    title: "Tormenta20 - Código de Poderes",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "Tormenta20 - Codice de Poderes.pdf",
    downloadUrl: T20_DRIVE_FOLDER_URL,
    viewUrl: T20_DRIVE_FOLDER_URL,
    driveUrl: T20_DRIVE_FOLDER_URL
  },
  {
    id: "t20-deuses-de-arton",
    system: "t20",
    systemLabel: { "pt-BR": "Tormenta20", en: "Tormenta20", es: "Tormenta20" },
    title: "Tormenta20 - Deuses de Arton",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "Tormenta20 - Deuses de Arton.pdf",
    downloadUrl: T20_DRIVE_FOLDER_URL,
    viewUrl: T20_DRIVE_FOLDER_URL,
    driveUrl: T20_DRIVE_FOLDER_URL
  },
  {
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "Tormenta20 - Guia de NPCs.pdf",
    downloadUrl: T20_DRIVE_FOLDER_URL,
    viewUrl: T20_DRIVE_FOLDER_URL,
    driveUrl: T20_DRIVE_FOLDER_URL
  },
  ...
  // ─── D&D 5e (2014) ──────────────────────────────────────────────────────────
  {
    id: "dnd5e-curse-of-strahd",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - Curse Of Strahd.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    id: "dnd5e-mordenkainens-tome-of-foes",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Mordenkainen's Tome of Foes",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - Mordenkainen's Tome of Foes.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    id: "dnd5e-storm-kings-thunder",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Storm King's Thunder",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - Storm King's Thunder.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    ...
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Strixhaven: Curriculum of Chaos",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - strixhaven curriculum of chaos.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    id: "dnd5e-hoard-of-the-dragon-queen",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Hoard of the Dragon Queen",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - Hoard of the Dragon Queen.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    id: "dnd5e-costa-da-espada",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Guia de Aventureiros da Costa da Espada",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "dd-5e-costa-da-espada-guia-de-aventureiros-fundo-colorido.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    id: "dnd5e-guildmasters-guide-to-ravnica",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Guildmasters' Guide to Ravnica",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - Guildmasters' Guide to Ravnica.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  {
    id: "dnd5e-princes-of-the-apocalypse",
    system: "dnd5e",
    systemLabel: { "pt-BR": "D&D 5e", en: "D&D 5e", es: "D&D 5e" },
    title: "D&D 5e - Princes of the Apocalypse",
    ...
    linkedRecords: 0,
    verifiedAt: "2026-09-21",
    filename: "D&D 5e - Princes of the Apocalypse.pdf",
    downloadUrl: DND5E_DRIVE_FOLDER_URL,
    viewUrl: DND5E_DRIVE_FOLDER_URL,
    driveUrl: DND5E_DRIVE_FOLDER_URL
  },
  ...
  {
    id: "ose-classic-fantasy",
    system: "ose",
    systemLabel: { "pt-BR": "Old-School Essentials", en: "Old-School Essentials", es: "Old-School Essentials" },
    title: "Old-School Essentials (Classic Fantasy)",
    ...
    linkedRecords: 53,
    verifiedAt: "2026-09-21",
    filename: "old-school-essentials.pdf",
    downloadUrl: OSE_DRIVE_FOLDER_URL,
    viewUrl: OSE_DRIVE_FOLDER_URL,
    driveUrl: OSE_DRIVE_FOLDER_URL
  },
  {
    id: "ose-advanced-fantasy",
    system: "ose",
    systemLabel: { "pt-BR": "Old-School Essentials", en: "Old-School Essentials", es: "Old-School Essentials" },
    title: "Old-School Essentials - Advanced Fantasy (Tomo do Jogador)",
    ...
    linkedRecords: 16,
    verifiedAt: "2026-09-21",
    filename: "old-school-essentials-advanced-fantasy-tomo-do-jogador.pdf",
    downloadUrl: OSE_DRIVE_FOLDER_URL,
    viewUrl: OSE_DRIVE_FOLDER_URL,
    driveUrl: OSE_DRIVE_FOLDER_URL
  },

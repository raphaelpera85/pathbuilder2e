export interface Dnd5eRaceRules {
  ...
  skillChoices?: number;
  raceChoices?: Dnd5eRaceChoice[];
}

export interface Dnd5eRaceChoice {
  id: string;
  label: string;
  options: string[];
  count: number;
...
const r = (id: string, name: string, sourcePage: number, abilityBonuses: string, attributeAdjustments: Dnd5eRaceRules["attributeAdjustments"], size: Dnd5eRaceRules["size"], speed: number, languages: string, traits: string[], abilityChoices?: Dnd5eRaceRules["abilityChoices"], languageChoices?: number, skillChoices?: number, raceChoices?: Dnd5eRaceChoice[]): Dnd5eRaceRules => ({ id, name, sourcePage, abilityBonuses, attributeAdjustments, size, speed, languages, traits, abilityChoices, languageChoices, skillChoices, raceChoices });

const DRACONIC_ANCESTRIES = ["Preto", "Azul", "Latão", "Bronze", "Cobre", "Ouro", "Verde", "Vermelho", "Prata", "Branco"];
const DWARF_TOOL_PROFICIENCIES = ["ferramentas de ferreiro", "suprimentos de cervejeiro", "ferramentas de pedreiro"];

export const DND5E_RACE_RULES: Dnd5eRaceRules[] = [
  r("anao", "Anão", 18, "Constituição +2", { con: 2 }, "Médio", 7.5, "Comum e Anão", ["Visão no escuro", "Resiliência anã", "Proficiência com ferramentas", "Treinamento de combate anão"], undefined, undefined, undefined, [{ id: "dwarf-tool-proficiency", label: "Proficiência com ferramentas de anão", options: DWARF_TOOL_PROFICIENCIES, count: 1 }]),
  ...
  r("draconato", "Draconato", 32, "Força +2, Carisma +1", { str: 2, cha: 1 }, "Médio", 9, "Comum e Dracônico", ["Ancestral dracônico", "Arma de sopro", "Resistência a dano"], undefined, undefined, undefined, [{ id: "draconic-ancestry", label: "Ancestralidade dracônica", options: DRACONIC_ANCESTRIES, count: 1 }]),

...
const r = (id: string, name: string, sourcePage: number, abilityBonuses: string, attributeAdjustments: Dnd5eRaceRules["attributeAdjustments"], size: Dnd5eRaceRules["size"], speed: number, languages: string, traits: string[]): Dnd5eRaceRules => ({ id, name, sourcePage, abilityBonuses, attributeAdjustments, size, speed, languages, traits });
...
export const DND5E_RACE_RULES: Dnd5eRaceRules[] = [
  ...
  r("humano", "Humano", 29, "+1 em todos os atributos", { str: 1, dex: 1, con: 1, int: 1, wis: 1, cha: 1 }, "Médio", 9, "Comum e um idioma adicional", ["Versátil", "Idioma adicional"]),
  ...
  r("meio_elfo", "Meio-Elfo", 38, "Carisma +2 e +1 em dois outros atributos", { cha: 2 }, "Médio", 9, "Comum, Élfico e um idioma adicional", ["Visão no escuro", "Ancestralidade feérica", "Versatilidade em perícias"]),

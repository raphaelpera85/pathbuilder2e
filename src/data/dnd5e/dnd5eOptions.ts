...
const DND5E_SUBCLASS_FEATURES: Record<string, Dnd5eSubclassFeature[]> = {
  ...
  clerigo_natureza: [sf(1, "Acólito da Natureza", "Aprende um truque de druida e ganha proficiência em uma perícia de natureza."), sf(1, "Proficiência Adicional", "Adquire proficiência com armaduras pesadas."), sf(2, "Encantar Animais e Plantas", "Usa Canalizar Divindade para enfeitiçar bestas e plantas."), sf(6, "Amortecer Elementos", "Usa reação para conceder resistência a dano elemental."), sf(8, "Golpe Divino", "Adiciona dano de frio, fogo ou elétrico a um ataque uma vez por turno."), sf(17, "Mestre da Natureza", "Comanda bestas e plantas enfeitiçadas e pode afetar várias criaturas.")],

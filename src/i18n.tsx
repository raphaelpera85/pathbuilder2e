...
const messages = {
  "pt-BR": {
    ...
    accountAccess: "Acesso à conta", createAccount: "Criar conta", username: "Usuário", email: "E-mail", password: "Senha", rememberAccount: "Lembrar minha conta",
  ...
  en: {
    ...
    accountAccess: "Account access", createAccount: "Create account", username: "Username", email: "Email", password: "Password", rememberAccount: "Remember my account",
  ...
  es: {
    ...
    accountAccess: "Acceso a la cuenta", createAccount: "Crear cuenta", username: "Usuario", email: "Correo", password: "Contraseña", rememberAccount: "Recordar mi cuenta",

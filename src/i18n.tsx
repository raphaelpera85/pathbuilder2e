...
const messages = {
  "pt-BR": {
    ...
    noCatalogResults: "Nenhum registro corresponde aos filtros.", loadingCatalog: "Carregando o catálogo do Supabase…", catalogLoadFailed: "Não foi possível carregar o catálogo agora.", filterCategory: "Filtrar categoria", catalogSearch: "Buscar no compêndio", toggleFilters: "Filtros", hideFilters: "Ocultar filtros",
    ...
    openGoogleDriveFolder: "Pasta Google Drive", openInGoogleDrive: "Ver no Google Drive", downloadBlankSheet: "Ficha em Branco (PDF)", downloadMapFolio: "Mapa-Múndi (Poster Map Folio)",
  ...
  en: {
    ...
    saveCurrent: "Save current sheet", characterHistory: "Character history", noCharacterHistory: "No version recorded.", savedAt: "Saved at", restoreVersion: "Restore version", newCharacter: "New character", refresh: "Refresh", myCharacters: "My characters", renameCharacter: "Rename character", renamePrompt: "New character name", noActiveCharacter: "No active character at the moment.",
    ...
    noCatalogResults: "No records match the filters.", loadingCatalog: "Loading the Supabase catalog…", catalogLoadFailed: "The catalog could not be loaded right now.", filterCategory: "Filter category", catalogSearch: "Search the compendium", toggleFilters: "Filters", hideFilters: "Hide filters",
    ...
    openGoogleDriveFolder: "Google Drive Folder", openInGoogleDrive: "View on Google Drive", downloadBlankSheet: "Blank Character Sheet (PDF)", downloadMapFolio: "World Map (Inner Sea Folio)",
    theme: "Theme", themeLight: "Light Theme", themeDark: "Dark Theme",
  },
  es: {
    ...
    noCatalogResults: "Ningún registro coincide con los filtros.", loadingCatalog: "Cargando el catálogo de Supabase…", catalogLoadFailed: "No se pudo cargar el catálogo ahora.", filterCategory: "Filtrar categoría", catalogSearch: "Buscar en el compendio", toggleFilters: "Filtros", hideFilters: "Ocultar filtros",
    ...
    openGoogleDriveFolder: "Carpeta de Google Drive", openInGoogleDrive: "Ver en Google Drive", downloadBlankSheet: "Ficha en Blanco (PDF)", downloadMapFolio: "Mapa del Mundo (Inner Sea Folio)",
    theme: "Tema", themeLight: "Tema Claro", themeDark: "Tema Oscuro",
  },
} as const;

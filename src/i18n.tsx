...
const messages = {
  "pt-BR": {
    ...
    gmEmailPlaceholder: "email.do.mestre@exemplo.com", hpPlaceholder: "PV", acPlaceholder: "CA", initiativePlaceholder: "Inic.", xpPlaceholder: "XP",
    ...
    yourLibrary: "Sua biblioteca", yourAccount: "Sua conta", close: "Fechar", libraryOf: "Biblioteca de", accountStorageCloud: "Nuvem (Supabase)", accountStorageLocal: "Armazenamento local seguro", deleteCharacterLabel: "Excluir",
    ...
    wait: "Aguarde…", adventurer: "Aventureiro", administrator: "Administrador", guest: "Convidado", saving: "Salvando…",
    saveCurrent: "Salvar ficha atual", characterHistory: "Histórico do personagem", noCharacterHistory: "Nenhuma versão registrada.", savedAt: "Salvo em", restoreVersion: "Restaurar versão", newCharacter: "Novo personagem", refresh: "Atualizar", myCharacters: "Meus personagens", renameCharacter: "Renomear personagem", duplicateCharacter: "Duplicar personagem", duplicateCharacterNotice: "Personagem duplicado com sucesso.", renamePrompt: "Novo nome do personagem", noActiveCharacter: "Nenhum personagem ativo no momento.",
    loadingSheets: "Carregando suas fichas…", charactersLoadFailed: "Não foi possível carregar suas fichas. Tente atualizar novamente.", noSheets: "Nenhuma ficha salva", noSheetsDescription: "Abra ou crie um personagem e salve uma cópia na sua conta.",
    ...
    accept: "Aceitar", cancel: "Cancelar", source: "Fonte", uncatalogued: "Ainda não catalogada", sourcePending: "Fonte pendente de confirmação", baseHp: "PV base",
    speed: "Velocidade", feet: "pés", hpPerLevel: "PV por nível", keyAbility: "Atributo-chave", damage: "Dano", damageType: "Tipo de dano", range: "Alcance", hands: "Mãos", reload: "Recarga", weaponCategory: "Categoria", weaponGroup: "Grupo", traits: "Traços", attributesModifiers: "Atributos e modificadores", savingThrows: "Salvamentos", deity: "Divindade", backstory: "Histórico",
    select: "Selecionar", ancestries: "Ancestralidades", classes: "Classes", subclasses: "Subclasses", backgrounds: "Antecedentes", skills: "Perícias", weapons: "Armas",
    armors: "Armaduras", shields: "Escudos", heritages: "Heranças", archetypes: "Arquétipos", spells: "Magias", rituals: "Rituais", feats: "Talentos", items: "Equipamentos", pets: "Mascotes & Companheiros", actions: "Ações", conditions: "Condições", buffs: "Benefícios", rules: "Regras", size: "Tamanho", configuration: "Configuração", landSpeed: "Deslocamento terrestre", swimSpeed: "Deslocamento de natação", climbSpeed: "Deslocamento de escalada",
    rank: "Círculo", traditions: "Tradições", castingTime: "Tempo de conjuração", primaryCheck: "Teste primário", spellCatalog: "Catálogo de Magias", addManualSpell: "Adicionar Magia Manualmente", addRitual: "Adicionar Ritual", knownSpells: "Magias Conhecidas", knownRituals: "Rituais Aprendidos",
    ...
    compendiumKicker: "BASE DE CONHECIMENTO PATHBUILDER", rulesKicker: "PROVENIÊNCIA DAS REGRAS PF2E", libraryKicker: "PATHBUILDER 2E · CONSTRUTOR DE PERSONAGENS", privacyKicker: "PRIVACIDADE POR DESIGN", gmPanelKicker: "PAINEL DO MESTRE · MESTRE DE JOGO",
    ...
    adminTitle: "Curadoria do compêndio", adminIntro: "Painel administrativo para acompanhar em tempo real acessos, contas cadastradas, personagens criados e cobertura das fontes.",
    adminManagementPanel: "Painel de Gestão & Métricas", adminStatsIntro: "Métricas consolidadas de acessos, contas cadastradas e fichas criadas no sistema.",
    totalAccesses: "Total de Acessos", accessesToday: "Acessos Hoje", registeredAccounts: "Contas Cadastradas", charactersCreated: "Personagens Criados", activeCampaigns: "Campanhas Criadas", adminUsers: "Administradores",
    recentVisitsLog: "Histórico de Acessos Recentes", registeredUsersList: "Usuários Cadastrados", refreshMetrics: "Atualizar Métricas", exportAuditReport: "Exportar Relatório",
    routeColumn: "Página / Rota", timestampColumn: "Data e Hora", userTypeColumn: "Tipo de Usuário", registeredDate: "Data de Cadastro", roleColumn: "Cargo / Papel",
    rulesetDistribution: "Distribuição por Regras", remasterSheets: "Fichas Remaster", legacySheets: "Fichas Legacy", loadingMetrics: "Carregando métricas de gestão…", metricsUpdated: "Métricas atualizadas com sucesso.",
    ...
    noCatalogResults: "Nenhum registro corresponde aos filtros.", catalogHiddenByFilters: "Há registros correspondentes ocultos por outro sistema ou edição; ajuste os filtros para visualizá-los.", loadingCatalog: "Carregando o catálogo do Supabase…", catalogLoadFailed: "Não foi possível carregar o catálogo agora.", filterCategory: "Filtrar categoria", catalogSearch: "Buscar no compêndio", toggleFilters: "Filtros", hideFilters: "Ocultar filtros",
    ...
    aiAssistantFree: "✨ Assistente IA (Grátis)", viewPlanMobile: "Plano (Níveis)", viewStatsMobile: "Ficha & Perícias", viewContentMobile: "Ações & Abas", deleteCampaignConfirm: "Deseja realmente excluir esta campanha/mesa?", campaignCreateFailed: "Erro ao criar campanha", campaignsSyncLocal: "A campanha está sendo exibida em modo local; a sincronização com a nuvem está indisponível.", remasterEdition: "Pathfinder 2e Remaster", classicEdition: "Pathfinder 2e Clássico", customEdition: "Regras Variantes / Híbrido",
    navDownloads: "Downloads de Livros", downloadsKicker: "DOWNLOADS & RECURSOS GOOGLE DRIVE", downloadsTitle: "Download dos Livros e Suplementos", downloadsIntro: "Baixe diretamente os livros de regras oficiais, suplementos e fichas em PDF hospedados no Google Drive.", rulesetStandard: "Padrão (2014)", rulesetT20: "Padrão", rulesetAdvanced: "Avançado", rulesetClassic: "Clássico", rulesetV35: "Edição 3.5", downloadPdfDirect: "Baixar PDF direto", viewOnGithub: "Ver no GitHub", openGithubRepo: "Repositório GitHub", openLivrosFolder: "Pasta /livros no GitHub", searchBooks: "Buscar livro por título ou idioma...", allLanguages: "Todos os Idiomas", downloadDirectNote: "Links diretos para download e visualização dos arquivos PDF armazenados no Google Drive.", downloadFromGithub: "Download GitHub", verifiedPdfsCount: "PDFs Oficiais Catalogados", downloadAllNotice: "Os arquivos PDF podem ser baixados individualmente abaixo ou acessados na pasta do Google Drive.",
    ...
    systemDnd35: "D&D 3.5", systemDnd35Desc: "Dungeons & Dragons 3.5ª Edição clássica (SRD / v3.5).",
  ...
  en: {
    ...
    gmEmailPlaceholder: "gm.email@example.com", hpPlaceholder: "HP", acPlaceholder: "AC", initiativePlaceholder: "Init.", xpPlaceholder: "XP",
    ...
    yourLibrary: "Your library", yourAccount: "Your account", close: "Close", libraryOf: "Library of", accountStorageCloud: "Cloud (Supabase)", accountStorageLocal: "Secure local storage", deleteCharacterLabel: "Delete",
    ...
    wait: "Please wait…", adventurer: "Adventurer", administrator: "Administrator", guest: "Guest", saving: "Saving…",
    saveCurrent: "Save current sheet", characterHistory: "Character history", noCharacterHistory: "No version recorded.", savedAt: "Saved at", restoreVersion: "Restore version", newCharacter: "New character", refresh: "Refresh", myCharacters: "My characters", renameCharacter: "Rename character", duplicateCharacter: "Duplicate character", duplicateCharacterNotice: "Character duplicated successfully.", renamePrompt: "New character name", noActiveCharacter: "No active character at the moment.",
    loadingSheets: "Loading your sheets…", charactersLoadFailed: "Could not load your sheets. Try refreshing.", noSheets: "No saved sheets", noSheetsDescription: "Open or create a character and save a copy to your account.",
    ...
    accept: "Accept", cancel: "Cancel", source: "Source", uncatalogued: "Not catalogued yet", sourcePending: "Source pending confirmation", baseHp: "Base HP",
    speed: "Speed", feet: "feet", hpPerLevel: "HP per level", keyAbility: "Key ability", damage: "Damage", damageType: "Damage type", range: "Range", hands: "Hands", reload: "Reload", weaponCategory: "Category", weaponGroup: "Group", traits: "Traits", attributesModifiers: "Attributes & modifiers", savingThrows: "Saving throws", deity: "Deity", backstory: "Backstory",
    select: "Select", ancestries: "Ancestries", classes: "Classes", subclasses: "Subclasses", backgrounds: "Backgrounds", skills: "Skills", weapons: "Weapons",
    armors: "Armor", shields: "Shields", heritages: "Heritages", archetypes: "Archetypes", spells: "Spells", rituals: "Rituals", feats: "Feats", items: "Gear & Items", pets: "Pets & Companions", actions: "Actions", conditions: "Conditions", buffs: "Benefits", rules: "Rules", size: "Size", configuration: "Configuration", landSpeed: "Land Speed", swimSpeed: "Swim Speed", climbSpeed: "Climb Speed",
    ...
    compendiumKicker: "PATHBUILDER KNOWLEDGE BASE", rulesKicker: "PF2E RULES PROVENANCE", libraryKicker: "PATHBUILDER 2E · CHARACTER BUILDER", privacyKicker: "PRIVACY BY DESIGN", gmPanelKicker: "GM PANEL · GAME MASTER",
    ...
    adminTitle: "Compendium curation", adminIntro: "Administrative dashboard for real-time tracking of visits, registered accounts, created characters, and source coverage.",
    adminManagementPanel: "Management & Metrics Panel", adminStatsIntro: "Consolidated metrics for platform visits, registered accounts, and created characters.",
    totalAccesses: "Total Visits", accessesToday: "Visits Today", registeredAccounts: "Registered Accounts", charactersCreated: "Characters Created", activeCampaigns: "Active Campaigns", adminUsers: "Administrators",
    recentVisitsLog: "Recent Access Log", registeredUsersList: "Registered Users", refreshMetrics: "Refresh Metrics", exportAuditReport: "Export Report",
    routeColumn: "Page / Route", timestampColumn: "Timestamp", userTypeColumn: "User Type", registeredDate: "Registration Date", roleColumn: "Role",
    rulesetDistribution: "Ruleset Distribution", remasterSheets: "Remaster Sheets", legacySheets: "Legacy Sheets", loadingMetrics: "Loading management metrics…", metricsUpdated: "Metrics successfully updated.",
    ...
    noCatalogResults: "No records match the filters.", catalogHiddenByFilters: "Matching records are hidden by another system or edition; adjust the filters to view them.", loadingCatalog: "Loading the Supabase catalog…", catalogLoadFailed: "The catalog could not be loaded right now.", filterCategory: "Filter category", catalogSearch: "Search the compendium", toggleFilters: "Filters", hideFilters: "Hide filters",
    ...
    aiAssistantFree: "✨ AI Assistant (Free)", viewPlanMobile: "Plan (Levels)", viewStatsMobile: "Sheet & Stats", viewContentMobile: "Actions & Tabs", deleteCampaignConfirm: "Are you sure you want to delete this campaign / table?", campaignCreateFailed: "Error creating campaign", campaignsSyncLocal: "This campaign is being shown locally; cloud synchronization is unavailable.", remasterEdition: "Pathfinder 2e Remaster", classicEdition: "Pathfinder 2e Classic", customEdition: "Variant / Custom Rules",
    navDownloads: "Book Downloads", downloadsKicker: "GOOGLE DRIVE DOWNLOADS & RESOURCES", downloadsTitle: "Books & Reference Downloads", downloadsIntro: "Directly download official rulebooks, supplements, and character sheets in PDF format hosted on Google Drive.", rulesetStandard: "Standard (2014)", rulesetT20: "Standard", rulesetAdvanced: "Advanced", rulesetClassic: "Classic", rulesetV35: "Edition 3.5", downloadPdfDirect: "Direct PDF Download", viewOnGithub: "View on GitHub", openGithubRepo: "GitHub Repository", openLivrosFolder: "GitHub /livros Folder", searchBooks: "Search book by title or language...", allLanguages: "All Languages", downloadDirectNote: "Direct download and viewing links for PDF files stored on Google Drive.", downloadFromGithub: "GitHub Download", verifiedPdfsCount: "Catalogued Official PDFs", downloadAllNotice: "PDF files can be downloaded individually below or accessed in the Google Drive folder.",
    ...
    systemDnd35: "D&D 3.5", systemDnd35Desc: "Dungeons & Dragons 3.5 Edition classic (SRD / v3.5).",
  ...
  es: {
    ...
    gmEmailPlaceholder: "correo.del.dj@ejemplo.com", hpPlaceholder: "PG", acPlaceholder: "CA", initiativePlaceholder: "Inic.", xpPlaceholder: "PX",
    ...
    yourLibrary: "Tu biblioteca", yourAccount: "Tu cuenta", close: "Cerrar", libraryOf: "Biblioteca de", accountStorageCloud: "Nube (Supabase)", accountStorageLocal: "Almacenamiento local seguro", deleteCharacterLabel: "Eliminar",
    ...
    wait: "Espera…", adventurer: "Aventurero", administrator: "Administrador", guest: "Invitado", saving: "Guardando…",
    saveCurrent: "Guardar ficha actual", characterHistory: "Historial del personaje", noCharacterHistory: "No hay versiones registradas.", savedAt: "Guardado en", restoreVersion: "Restaurar versión", newCharacter: "Nuevo personaje", refresh: "Actualizar", myCharacters: "Mis personajes", renameCharacter: "Renombrar personaje", duplicateCharacter: "Duplicar personaje", duplicateCharacterNotice: "Personaje duplicado correctamente.", renamePrompt: "Nuevo nombre del personaje", noActiveCharacter: "No hay un personaje activo en este momento.",
    loadingSheets: "Cargando tus fichas…", charactersLoadFailed: "No se pudieron cargar tus fichas. Intenta actualizar.", noSheets: "No hay fichas guardadas", noSheetsDescription: "Abre o crea un personaje y guarda una copia en tu cuenta.",
    level: "Nivel", rulesReview: "Reglas por revisar", profileSettings: "Configuración del perfil", updateUsername: "Atualizar usuario",
    ...
    accept: "Aceptar", cancel: "Cancelar", source: "Fuente", uncatalogued: "No catalogada aún", sourcePending: "Fuente pendiente de confirmación", baseHp: "PG base",
    speed: "Velocidad", feet: "pies", hpPerLevel: "PG por nivel", keyAbility: "Atributo clave", damage: "Daño", damageType: "Tipo de daño", range: "Alcance", hands: "Manos", reload: "Recarga", weaponCategory: "Categoría", weaponGroup: "Grupo", traits: "Rasgos", attributesModifiers: "Atributos y modificadores", savingThrows: "Salvaciones", deity: "Divinidad", backstory: "Historia",
    select: "Seleccionar", ancestries: "Ascendencias", classes: "Clases", subclasses: "Subclases", backgrounds: "Trasfondos", skills: "Habilidades", weapons: "Armas",
    armors: "Armaduras", shields: "Escudos", heritages: "Herencias", archetypes: "Arquetipos", spells: "Conjuros", rituals: "Rituales", feats: "Dotes", items: "Equipo y Objetos", pets: "Mascotas y Compañeros", actions: "Acciones", conditions: "Condiciones", buffs: "Beneficios", rules: "Reglas", size: "Tamaño", configuration: "Configuración", landSpeed: "Velocidad terrestre", swimSpeed: "Velocidad de nado", climbSpeed: "Velocidad de escalada",
    ...
    compendiumKicker: "BASE DE CONOCIMIENTO PATHBUILDER", rulesKicker: "PROVENIENCIA DE REGLAS PF2E", libraryKicker: "PATHBUILDER 2E · CREADOR DE PERSONAJES", privacyKicker: "PRIVACIDAD POR DISEÑO", gmPanelKicker: "PANEL DEL DJ · DIRECTOR DE JUEGO",
    ...
    adminTitle: "Curaduría del compendio", adminIntro: "Panel administrativo para el seguimiento en tiempo real de visitas, cuentas registradas, personajes creados y cobertura de fuentes.",
    adminManagementPanel: "Panel de Gestión y Métricas", adminStatsIntro: "Métricas consolidadas de visitas, cuentas registradas y personajes creados en el sistema.",
    totalAccesses: "Total de Accesos", accessesToday: "Accesos Hoy", registeredAccounts: "Cuentas Registradas", charactersCreated: "Personajes Creados", activeCampaigns: "Campañas Creadas", adminUsers: "Administradores",
    recentVisitsLog: "Historial de Accesos Recientes", registeredUsersList: "Usuarios Registrados", refreshMetrics: "Actualizar Métricas", exportAuditReport: "Exportar Informe",
    routeColumn: "Página / Ruta", timestampColumn: "Fecha y Hora", userTypeColumn: "Tipo de Usuario", registeredDate: "Fecha de Registro", roleColumn: "Rol",
    rulesetDistribution: "Distribución por Reglas", remasterSheets: "Fichas Remaster", legacySheets: "Fichas Legacy", loadingMetrics: "Cargando métricas de gestión…", metricsUpdated: "Métricas actualizadas correctamente.",
    ...
    noCatalogResults: "Ningún registro coincide con los filtros.", catalogHiddenByFilters: "Hay registros coincidentes ocultos por otro sistema o edición; ajusta los filtros para verlos.", loadingCatalog: "Cargando el catálogo de Supabase…", catalogLoadFailed: "No se pudo cargar el catálogo ahora.", filterCategory: "Filtrar categoría", catalogSearch: "Buscar en el compendio", toggleFilters: "Filtros", hideFilters: "Ocultar filtros",
    formulas: "Fórmulas y Alquimia", allRulesets: "Todos los Conjuntos de Reglas", allRarities: "Todas las Rarezas", allBooks: "Todos los Libros / Fuentes",
    ...
    aiAssistantFree: "✨ Asistente IA (Gratis)", viewPlanMobile: "Plan (Niveles)", viewStatsMobile: "Ficha y Habilidades", viewContentMobile: "Acciones y Pestañas", deleteCampaignConfirm: "¿Seguro que deseas eliminar esta campaña/mesa?", campaignCreateFailed: "Error al crear la campaña", campaignsSyncLocal: "La campaña se muestra localmente; la sincronización en la nube no está disponible.", remasterEdition: "Pathfinder 2e Remaster", classicEdition: "Pathfinder 2e Clásico", customEdition: "Reglas Variantes / Híbridas",
    navDownloads: "Descargas de Libros", downloadsKicker: "DESCARGAS Y RECURSOS GOOGLE DRIVE", downloadsTitle: "Descarga de Libros y Suplementos", downloadsIntro: "Descarga directamente los libros de reglas oficiales, suplementos y fichas en PDF alojados en Google Drive.", rulesetStandard: "Estándar (2014)", rulesetT20: "Estándar", rulesetAdvanced: "Avanzado", rulesetClassic: "Clásico", rulesetV35: "Edición 3.5", downloadPdfDirect: "Descargar PDF directo", viewOnGithub: "Ver en GitHub", openGithubRepo: "Repositorio GitHub", openLivrosFolder: "Carpeta /livros en GitHub", searchBooks: "Buscar libro por título o idioma...", allLanguages: "Todos os Idiomas", downloadDirectNote: "Enlaces directos para descarga y visualización de los archivos PDF almacenados en Google Drive.", downloadFromGithub: "Descargar GitHub", verifiedPdfsCount: "PDFs Oficiales Catalogados", downloadAllNotice: "Los archivos PDF se pueden descargar individualmente abajo o acceder en la carpeta de Google Drive.",
    ...
    systemPf2e: "Pathfinder 2e", systemPf2eDesc: "Reglas Remaster e Legado completas, 28 clases, dotes y conjuros.",
    ...
    systemDnd35: "D&D 3.5", systemDnd35Desc: "Dungeons & Dragons 3.5 Edición clásica (SRD / v3.5).",
...
/** Lista as chaves canônicas para auditorias de localização. */
export function listMessageKeys(): MessageKey[] {
  return Object.keys(messages["pt-BR"]) as MessageKey[];
}

/** Verifica a cobertura estrutural do catálogo para evitar fallback silencioso. */
export function getTranslationCoverage(): Record<Locale, { missing: string[]; extra: string[] }> {
  const keySets = Object.fromEntries(
    (Object.keys(messages) as Locale[]).map((locale) => [locale, new Set(Object.keys(messages[locale]))]),
  ) as Record<Locale, Set<string>>;
  const allKeys = new Set(Object.values(keySets).flatMap((keys) => [...keys]));
  return Object.fromEntries(
    (Object.keys(messages) as Locale[]).map((locale) => [locale, {
      missing: [...allKeys].filter((key) => !keySets[locale].has(key)).sort(),
      extra: [...keySets[locale]].filter((key) => !keySets["pt-BR"].has(key)).sort(),
    }]),
  ) as Record<Locale, { missing: string[]; extra: string[] }>;
}

...
const messages = {
  "pt-BR": {
    ...
    saveCurrent: "Salvar ficha atual", newCharacter: "Novo personagem", refresh: "Atualizar", myCharacters: "Meus personagens", renameCharacter: "Renomear personagem", renamePrompt: "Novo nome do personagem", noActiveCharacter: "Nenhum personagem ativo no momento.",
  ...
  en: {
    ...
    saveCurrent: "Save current sheet", newCharacter: "New character", refresh: "Refresh", myCharacters: "My characters", renameCharacter: "Rename character", renamePrompt: "New character name", noActiveCharacter: "No active character at the moment.",
  ...
  es: {
    ...
    saveCurrent: "Guardar ficha actual", newCharacter: "Nuevo personaje", refresh: "Actualizar", myCharacters: "Mis personajes", renameCharacter: "Renombrar personaje", renamePrompt: "Nuevo nombre del personaje", noActiveCharacter: "No hay un personaje activo en este momento.",

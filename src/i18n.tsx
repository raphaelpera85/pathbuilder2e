...
const messages = {
  "pt-BR": {
    ...
    navDownloads: "Downloads de Livros", downloadsKicker: "DOWNLOADS & RECURSOS GOOGLE DRIVE", downloadsTitle: "Download dos Livros e Suplementos", downloadsIntro: "Baixe diretamente os livros de regras oficiais, suplementos e fichas em PDF hospedados no Google Drive.", rulesetStandard: "Padrão (2014)", rulesetT20: "Padrão", rulesetAdvanced: "Avançado", rulesetClassic: "Clássico", downloadPdfDirect: "Baixar PDF direto", viewOnGithub: "Ver no GitHub", openGithubRepo: "Repositório GitHub", openLivrosFolder: "Pasta /livros no GitHub", searchBooks: "Buscar livro por título ou idioma...", allLanguages: "Todos os Idiomas", downloadDirectNote: "Links diretos para download e visualização dos arquivos PDF armazenados no Google Drive.", downloadFromGithub: "Download GitHub", verifiedPdfsCount: "PDFs Oficiais Catalogados", downloadAllNotice: "Os arquivos PDF podem ser baixados individualmente abaixo ou acessados na pasta do Google Drive.",
  ...
  en: {
    ...
    navDownloads: "Book Downloads", downloadsKicker: "GOOGLE DRIVE DOWNLOADS & RESOURCES", downloadsTitle: "Books & Reference Downloads", downloadsIntro: "Directly download official rulebooks, supplements, and character sheets in PDF format hosted on Google Drive.", rulesetStandard: "Standard (2014)", rulesetT20: "Standard", rulesetAdvanced: "Advanced", rulesetClassic: "Classic", downloadPdfDirect: "Direct PDF Download", viewOnGithub: "View on GitHub", openGithubRepo: "GitHub Repository", openLivrosFolder: "GitHub /livros Folder", searchBooks: "Search book by title or language...", allLanguages: "All Languages", downloadDirectNote: "Direct download and viewing links for PDF files stored on Google Drive.", downloadFromGithub: "GitHub Download", verifiedPdfsCount: "Catalogued Official PDFs", downloadAllNotice: "PDF files can be downloaded individually below or accessed in the Google Drive folder.",

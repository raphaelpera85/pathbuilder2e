...
const messages = {
  "pt-BR": {
    ...
    noCatalogResults: "Nenhum registro corresponde aos filtros.", filterCategory: "Filtrar categoria", catalogSearch: "Buscar no compêndio", toggleFilters: "Filtros", hideFilters: "Ocultar filtros",
  ...
  en: {
    ...
    noCatalogResults: "No records match the filters.", filterCategory: "Filter category", catalogSearch: "Search the compendium", toggleFilters: "Filters", hideFilters: "Hide filters",
  ...
  es: {
    ...
    noCatalogResults: "Ningún registro coincide con los filtros.", filterCategory: "Filtrar categoría", catalogSearch: "Buscar en el compendio", toggleFilters: "Filtros", hideFilters: "Ocultar filtros",

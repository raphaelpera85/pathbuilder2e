...
PF2E_DATA.items = [
  ...
  { id: "item.magic.striking_rune", name: "Runa de Impacto (Striking Rune)", names: { "pt-BR": "Runa de Impacto", en: "Striking Rune", es: "Runa de impacto" }, mainCategory: "magic_items", subCategory: "runes", level: 4, price: { gp: 65 }, bulk: "-", traits: ["Mágico", "Runa"], description: "Dobra os dados de dano de arma (ex: 1d8 passa para 2d8).", source: { book: "Livro do Jogador (Player Core)", page: 308 } }
];

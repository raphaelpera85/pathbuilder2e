...
- [ ] Completar idiomas e todas as escolhas condicionais raciais.
  ...
  - Progresso adicional D&D 5e: a proficiência racial oficial em Percepção do Elfo agora entra no conjunto treinado, no bônus da perícia e na ficha derivada, em vez de permanecer apenas como texto narrativo.
  - Progresso adicional D&D 5e: Resistência Anã a veneno e Resistência Infernal do Tiefling agora alimentam `damageResistances` da ficha, além do resumo racial.
  - Progresso adicional D&D 5e: Sortudo do Halfling agora é uma regra de rerrolagem derivada e exportável, sem ser confundida com vantagem/desvantagem global.
  - Progresso adicional D&D 5e: vantagens raciais condicionais de Anão, Elfo/Meio-Elfo, Halfling e Gnomo agora possuem bloco derivado próprio na ficha/PDF, preservando o contexto do salvamento.
  - Progresso adicional D&D 5e: Mago de Guerra agora registra vantagem contextual em salvamentos de Constituição para manter concentração, sem alterar os demais salvamentos.
  - Progresso adicional D&D 5e: Elfo e Meio-Elfo agora derivam imunidade a sono mágico no bloco de imunidades condicionais, além da descrição racial.
  - Progresso adicional D&D 5e: Indomável do Guerreiro e Alma de Diamante do Monge agora aparecem como regras de rerrolagem contextual com seus marcos de nível.
  ...
  - Progresso adicional T20: o Caminho do Cavaleiro agora aplica operacionalmente RD 5 para Bastião enquanto o personagem usa armadura pesada; Montaria permanece separada como escolha de benefício narrativo/companheiro.
  - Progresso adicional T20: Aura Sagrada do Paladino agora aplica o modificador de Carisma aos salvamentos de Fortitude, Reflexos e Vontade a partir do 3º nível, com regressão de nível e atributo.
  - Progresso adicional T20: Bênção da Justiça do Paladino agora descreve os efeitos escalonados de Égide Sagrada (+Carisma na Defesa, aprimoramento mágico no 11º nível) e Montaria Sagrada (aliado iniciante/veterano/mestre nos níveis 5/11/17), com custos e vínculo da montaria visíveis no construtor, ficha e PDF.
  - Progresso adicional T20: Virtudes Paladinescas agora somam PM ao máximo conforme a quantidade escolhida (1/3/6/10/15 para 1–5 virtudes) e exibem o total derivado nos efeitos da ficha/PDF.
  - Progresso adicional T20: Virtude Paladinesca — Castidade agora deriva imunidade a Enfeitiçado no bloco de condições da ficha quando o poder está selecionado.
...
- [ ] Poderes e escolhas de classe por nível.
  - Progresso adicional: escolhas estruturais D&D 5e de Estilo de Luta (Guerreiro/Paladino/Patrulheiro), Inimigo/Terreno Favorecidos do Patrulheiro (incluindo o terceiro inimigo do 14º nível), Metamagia e Dádiva do Pacto, além de escolhas T20 de escolas do Bardo, inimigo/terreno do Caçador, caminho do Cavaleiro, perícias de Especialista do Ladino e Bênção da Justiça do Paladino agora são catalogadas, exibidas no wizard/ficha, persistidas em `classChoices`, derivadas no bloco de efeitos da ficha e validadas por nível; outras escolhas situacionais de classe ainda precisam de grupos estruturados.
  - Correção adicional D&D 5e: Metamagia do Feiticeiro agora cresce de 2 para 3 e 4 escolhas nos níveis 10 e 17, respectivamente, e o limite é aplicado no wizard, na limpeza de edição e na validação (`countByLevel`).
  ...
  - Progresso adicional D&D 5e: Ataque Descuidado do Bárbaro agora é um modo persistido e editável a partir do 2º nível; aplica vantagem aos ataques corpo a corpo com Força, cancela a desvantagem global conforme a regra de vantagem/desvantagem e é registrado no PDF.
  - Progresso adicional de qualidade: fixtures estruturais cobrem todas as classes e raças de T20, D&D 5e e OSE; o exportador PDF editável OSE agora possui teste explícito de uma página para Advanced e Classic.
  - Progresso OSE: montarias/animais e retentores especialistas do catálogo agora podem ser comprados/selecionados no editor, respeitam ouro e limite de lacaios por Carisma, persistem na reabertura e são incluídos na ficha/PDF editável.
  - Correção de integridade OSE: `validateOseFollowers` rejeita animais/retentores fora do catálogo, duplicidades e excesso de lacaios também em fichas legadas ou payloads alterados; o fechamento do editor usa essa validação nos dois rulesets.
  - Evidência adicional OSE: o teste de PDF editável confirma que montarias e lacaios aparecem tanto no campo de habilidades/equipamentos quanto nas notas da ficha de uma página.
...
- [x] Teste de criação, salvamento, recarregamento e exportação.
  ...
  - Correção de ruleset: a normalização localizada agora distingue `OSE Classic Fantasy` (`classic`) de `Pathfinder 2e Clássico`/`pré-Remaster` (`legacy`), evitando reabrir uma ficha com regras de outro sistema.
...
- [ ] Habilidades de classe, características por nível e efeitos completos das subclasses.
  ...
  - Progresso adicional: o Estilo de Luta Luta com Armas Grandes agora marca cada ataque corpo a corpo de duas mãos ou versátil com a regra operacional de rerrolar resultados 1–2 nos dados de dano; a indicação aparece na ficha e nas notas do PDF editável.
  - Progresso adicional: Escola de Abjuração agora deriva a capacidade da Salvaguarda Arcana (2 × nível + Inteligência), e Escola de Adivinhação deriva 2d20/3d20 de Presságio nos níveis 2/14, exibidos nos efeitos da ficha e exportados pelo PDF.
  - Progresso adicional: Saúde Divina do Paladino (nível 3), Aura de Coragem (nível 10) e Pureza do Corpo do Monge (nível 10) agora aparecem como imunidades condicionais derivadas, com testes de nível de fronteira.
  - Progresso adicional: Mente Escorregadia do Ladino (nível 15) e Alma de Diamante do Monge (nível 14) agora concedem proficiência de salvamento no cálculo derivado, com testes de transição de nível.
  - Progresso adicional: Versatilidade do Bardo agora aplica metade do bônus de proficiência a perícias não treinadas a partir do nível 2.
  - Progresso adicional: Sentido de Perigo do Bárbaro agora aplica vantagem em salvamentos de Destreza a partir do nível 2, respeitando cegueira, incapacitação e anulação por desvantagem.
  - Progresso adicional: Instinto Feral do Bárbaro agora aplica vantagem na iniciativa a partir do nível 7; a ficha e o PDF exibem o modo de rolagem e a desvantagem global anula a vantagem conforme a regra de D&D 5e.
  - Progresso adicional: recursos de classe D&D 5e agora exibem Indomável do Guerreiro (1/2/3 usos nos níveis 9/13/17) e Toque Purificador do Paladino (usos pelo modificador de Carisma a partir do 14º nível), com testes de fronteira.
  - Progresso adicional: Canção de Descanso do Bardo agora aparece como recurso a partir do 2º nível e escala para d6/d8/d10/d12 nos marcos oficiais.
  - Progresso adicional: Magia de Pacto do Bruxo agora aparece com quantidade/círculo de espaços por nível, e Arcana Mística 6º–9º é exibida nos marcos 11/13/15/17.
  - Progresso adicional D&D 5e: Mestre de Armadura Pesada agora deriva redução de 3 pontos contra dano físico não mágico somente enquanto armadura pesada está equipada, exibindo o efeito na ficha e no PDF.
  - Progresso adicional D&D 5e: Durável agora calcula e exibe o mínimo de cura ao gastar Dados de Vida, usando o modificador de Constituição após o aumento concedido pelo talento.
  - Progresso adicional D&D 5e: Fúria Incansável do Bárbaro agora aparece como salvamento de Constituição com CD crescente por uso, e Elusivo do Ladino como regra defensiva contextual a partir do 18º nível; ambos são exibidos no construtor, ficha e PDF.
  - Progresso adicional D&D 5e: Matador de Colossos do Caçador agora adiciona o dano condicional de +1d8 ao primeiro ataque que acertar um alvo já ferido, incluindo ataques à distância.
  - Progresso adicional D&D 5e: as escolhas Táticas Defensivas e Defesa Superior do Caçador agora geram regras defensivas contextuais no nível correto e são exportadas.
  - Progresso adicional D&D 5e: Matador de Gigantes, Destruidor de Hordas, Saraivada e Ataque de Redemoinho do Caçador agora aparecem em um bloco de regras de combate condicionado à escolha e ao nível.
  - Progresso adicional D&D 5e: Palavras Cortantes do Colégio do Conhecimento e Inspiração de Combate/Magia de Batalha do Colégio do Valor agora aparecem como regras de combate condicionais; Ataque Extra do Valor permanece derivado nos ataques a partir do 6º nível.
  - Progresso adicional D&D 5e: Assassinato/Golpe Mortal do Ladino Assassino, Reflexos de Ladrão e Trapaceiro Versátil agora aparecem como regras de combate contextuais nos níveis oficiais.
  - Progresso adicional D&D 5e: Fulgor de Proteção do Domínio da Luz, Fúria da Tormenta/Sacerdote da Guerra e Golpe Divino dos domínios de Clérigo agora possuem efeitos defensivos, de combate e de dano condicional.
  - Progresso adicional D&D 5e: Truque Potente, Evocação Potencializada e Sobrecarga da Escola de Evocação, além de Eu Ilusório e Encanto Instintivo, agora são regras defensivas/ofensivas contextuais do Mago.
  - Progresso adicional D&D 5e: Marés do Caos, Distorcer a Sorte e Bombardeio de Magia da Magia Selvagem agora aparecem como regras de combate contextuais nos níveis oficiais.
  - Progresso adicional D&D 5e: Bênção do Senhor Sombrio, Fuga Nebulosa e Proteção Entrópica dos Patronos de Bruxo agora aparecem como regras de combate/defesa contextuais.
  - Progresso adicional D&D 5e: Espírito Totêmico do Bárbaro agora aplica resistência do Urso e regras contextuais de Águia/Lobo somente enquanto a Fúria está ativa.
  - Progresso adicional D&D 5e: as Tradições da Mão Aberta e das Sombras do Monge agora possuem regras de combate acionáveis por nível, incluindo Rajada de Golpes, Passo das Sombras, Oportunista e Palma Vibrante.
  - Progresso adicional D&D 5e: o Círculo da Lua agora deriva os quatro marcos de Forma Selvagem e os exporta como regras de combate contextuais.
  - Progresso adicional D&D 5e: os Juramentos de Devoção, dos Anciões e de Vingança agora derivam Arma Sagrada, Aura de Proteção dos Anciões, Voto de Inimizade e Alma de Vingança nos níveis oficiais, com separação entre efeitos defensivos e de combate.
  - Progresso adicional: Talento Confiável do Ladino agora marca o resultado mínimo 10 nas perícias treinadas a partir do nível 11, exibido na ficha e no PDF.
  - Progresso adicional: Destruição Divina Aprimorada do Paladino D&D 5e agora adiciona +1d8 radiante como dano condicional aos ataques corpo a corpo a partir do 11º nível, sem aplicar o efeito a ataques à distância.
  - Progresso adicional: Destruição Divina do Paladino D&D 5e agora possui modo opcional persistido; o jogador escolhe o círculo do espaço (1º–5º), o motor deriva 2d8–5d8 no ataque corpo a corpo e a ficha valida classe, nível e limite do espaço escolhido.
  - Correção adicional D&D 5e: o ataque desarmado agora aparece automaticamente para qualquer personagem, com dano base 1 + Força; para Monge, usa Destreza, dado de Artes Marciais por nível e Ataque Extra quando disponível.
  - Progresso adicional D&D 5e: Contracanto do Bardo agora deriva vantagem situacional em salvamentos contra amedrontamento e enfeitiçamento a partir do 6º nível, sendo exibido na ficha e exportado sem alterar a rolagem global.
  - Progresso adicional D&D 5e: Golpe de Sorte do Ladino agora aparece como regra contextual no 20º nível, com uso único por descanso longo e conversão de uma falha em sucesso/20 natural.
...
- [x] O construtor OSE exibe a progressão da classe selecionada por nível (dado de vida, THAC0, AAC, salvamentos, espaços e habilidades) antes da finalização.
...
- [x] Filtrar compêndio por sistema, edição/ruleset, fonte e idioma.
  ...
  - Auditoria de cobertura fortalecida: o contrato agora fixa os lotes nucleares atuais por sistema — T20 17 raças/14 classes/150 itens/66 magias/412 poderes/29 perícias; D&D 5e 9/12/226/315/40/18; OSE 10/16/53/34 e 45 entradas de perícias Advanced — evitando regressões silenciosas de catálogo.
...
- [x] Completar seeds versionados para perícias, poderes/talentos, itens e magias.
  ...
  - Verificação remota atual: T20 (`padrao`) = 150 itens, 66 magias e 412 poderes; D&D 5e (`standard`) = 226 itens, 315 magias e 40 talentos; OSE (`advanced`) = 53 itens e 34 magias; OSE (`classic`) = 53 itens e 34 magias; PF2e permanece separado por ruleset.

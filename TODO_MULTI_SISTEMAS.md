...
- [ ] Poderes e escolhas de classe por nível.
  - Progresso adicional: escolhas estruturais D&D 5e de Estilo de Luta (Guerreiro/Paladino/Patrulheiro), Inimigo/Terreno Favorecidos do Patrulheiro, Metamagia e Dádiva do Pacto, além de escolhas T20 de escolas do Bardo, inimigo/terreno do Caçador, caminho do Cavaleiro, perícias de Especialista do Ladino e Bênção da Justiça do Paladino agora são catalogadas, exibidas no wizard/ficha, persistidas em `classChoices`, derivadas no bloco de efeitos da ficha e validadas por nível; outras escolhas situacionais de classe ainda precisam de grupos estruturados.

...
## Knowledge Gaps
- **930 isolated node(s):** `verifiedAncestry`, `verifiedHeritage`, `verifiedArchetype`, `verifiedSpell`, `verifiedRitual` (+925 more)

...
## Corpus Check
- 225 files · ~3,179,274 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1931 nodes · 3060 edges · 166 communities (115 shown, 51 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 51 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dede9686`
...
## Knowledge Gaps
- **939 isolated node(s):** `ActionDefinition`, `FeatDefinition`, `PetCompanionDefinition`, `CatalogTableName`, `I18nValue` (+934 more)
...
- **What connects `ActionDefinition`, `FeatDefinition`, `PetCompanionDefinition` to the rest of the system?**

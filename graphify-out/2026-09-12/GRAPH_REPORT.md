# Graph Report - pathbuilder2e_local  (2026-09-10)

## Corpus Check
- 265 files · ~13,959,958 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2104 nodes · 3277 edges · 180 communities (131 shown, 49 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be02cbd5`
...
Cohesion: 0.08
Nodes (81): AccountPortal(), AuthMode, updateAccountViewState(), CampaignsPage(), isSupabaseConfigured, supabase, SUPABASE_PROJECT_KEY, SUPABASE_PROJECT_URL (+73 more)
...
Cohesion: 0.06
Nodes (28): verifiedAncestry, verifiedArchetype, verifiedHeritage, verifiedRitual, verifiedSpell, IAttributePipelineResult, ICharacterAbilities, ICharacterCoins (+20 more)

### Community 10 - "PickerModal.tsx"
Cohesion: 0.18
Nodes (20): localizeSourceBookName(), formatGeneratedPrerequisite(), getLocalizedPrerequisiteNames(), getLocalizedSkillName(), getPrerequisiteMessage(), getTraditionDisplayNames(), getTraitDisplayName(), getWeaponProficiencyRank() (+12 more)
...
Cohesion: 0.10
Nodes (26): ANCESTRY_TRANSLATIONS, BACKGROUND_TRANSLATIONS, CLASS_TRANSLATIONS, getItemDisplayName(), getStoredLocale(), getTranslationCoverage(), I18nContext, I18nProvider() (+18 more)
...
### Community 26 - "economy.ts"
Cohesion: 0.56
Nodes (8): canAffordPrice(), Coins, coinsToCopper(), copperToCoins(), deductCoins(), formatCopperToString(), formatPriceToLocale(), parsePriceToCopper()
...
Cohesion: 0.23
Nodes (5): ClientInputError, PathbuilderHandler, PayloadTooLargeError, Pathbuilder 2e Local - Servidor HTTP e API de Personagens Executa um servidor…, ValueError
...
### Community 83 - "CatalogPage"
Cohesion: 0.19
Nodes (16): getItemImageAlt(), getItemImageUrl(), getItemVisualKey(), itemIdentity(), ItemVisualData, localProjectAssetUrl(), CatalogCard(), CatalogPage() (+8 more)
...
Cohesion: 0.06
Nodes (42): AccountViewState, listeners, snapshot, subscribe(), useAccountViewState(), GoogleDrivePdf, googleDrivePdfs, additionalDownloadResources (+34 more)
...
Cohesion: 0.10
Nodes (18): ActionDefinition, PF2E_ACTIONS_CATALOG, RAW_ACTIONS, locales, LegacyRecord, GUNS_GEARS_EQUIPMENT, ItemDefinition, PF2E_ITEMS_CATALOG (+10 more)
...
## Knowledge Gaps
- **1039 isolated node(s):** `PortalRoute`, `routes`, `navItems`, `catalogCategories`, `validationCopy` (+1034 more)
...
- **Why does `PathbuilderApp` connect `PathbuilderApp` to `.renderAll`, `.applyPickerSelection`, `.renderDetailsTab`, `.renderModalLeftList`, `escapeHtml`, `.generateCharacterWithAI`, `.loadInitialCharacter`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `IPickerController` connect `IPickerController` to `types.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `signUp()` connect `characters.ts` to `PortalPages.tsx`?**

...
## Summary
- 15738 nodes · 22950 edges · 1016 communities (879 shown, 123 thin omitted)
...
## Communities (1016 total, 123 thin omitted)
...
### Community 69 - "tasteforge/resolve.py"
Cohesion: 0.18
...
### Community 97 - "symbol_resolution.py"
Cohesion: 0.18
...
### Community 198 - "_extract_python_rationale"
Cohesion: 0.24
...
### Community 429 - "grade_clip_adaptive"
Cohesion: 0.28
...
### Community 449 - "_resolve_php_type_references"
Cohesion: 0.36
...
### Community 520 - "_platform_skill_destination"
Cohesion: 0.29
...
### Community 553 - "_remove_marker_section"
Cohesion: 0.25
...
## Knowledge Gaps
- **7198 isolated node(s):** `AuthMode`, `PortalRoute`, `routes`, `navItems`, `catalogCategories` (+7193 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 9903 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **123 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `dispatch_command()` connect `graphify/cli.py` to `scope_semantic_result`, `write_callflow_html`, `_platform_skill_destination`, `cache.py`, `Path`, `save_semantic_cache`, `querylog.py`, `Path`, `graphify/export.py`, `detect`, `serve.py`, `build.py`, `_build_server`, `check_graph_file_size_cap`, `llm.py`, `affected.py`, `paths.py`, `graphify/__main__.py`, `ingest.py`, `to_wiki`, `link_cross_repo_member_calls`, `reflect.py`, `analyze.py`, `hooks.py`, `introspect_cargo`, `diagnostics.py`, `semantic_cleanup.py`, `Path`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `_file_stem()` connect `_make_id` to `extract_json`, `extract_commonlisp`, `extract_bash`, `extract_xaml`, `_read_text`, `verilog.py`, `Path`, `build.py`, `mcp_ingest.py`, `sanitize_metadata`, `extract_rust`, `extract_go`, `extract_fortran`, `_extract_python_rationale`, `extract.py`, `extract_objc`, `extract_robot`, `symbol_resolution.py`, `extract_pascal`, `extract_elixir`, `extract_ocaml`, `extract_dm`, `extract_sql`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `_make_id()` connect `_make_id` to `extract_json`, `extract_commonlisp`, `extract_bash`, `extract_xaml`, `_read_text`, `verilog.py`, `Path`, `graphify/cli.py`, `sanitize_metadata`, `extract_rust`, `extract_go`, `_resolve_php_type_references`, `extract_fortran`, `_extract_python_rationale`, `extract.py`, `extract_objc`, `extract_robot`, `make_id`, `extract_pascal`, `extract_elixir`, `extract_ocaml`, `extract_dm`, `extract_terraform`, `extract_sql`, `_resolve_csharp_type_references`?**

...
## Corpus Check
- 1091 files · ~15,087,294 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15558 nodes · 22577 edges · 1010 communities (866 shown, 115 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 541 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `957fe3a8`
...
## Communities (1010 total, 115 thin omitted)
...
Cohesion: 0.13
Nodes (47): AccountPortal(), AuthMode, updateAccountViewState(), LibraryPage(), AuthSession, buildUserProfileFromAuth(), changePassword(), deleteAccount() (+39 more)
...
Cohesion: 0.05
Nodes (29): verifiedAncestry, verifiedArchetype, verifiedHeritage, verifiedRitual, verifiedSpell, IAttributePipelineResult, ICharacterAbilities, ICharacterCoins (+21 more)

### Community 10 - "PickerModal.tsx"
Cohesion: 0.17
Nodes (22): localizeSourceBookName(), getItemDisplayName(), formatGeneratedPrerequisite(), getLocalizedPrerequisiteNames(), getLocalizedSkillName(), getPrerequisiteMessage(), getTraditionDisplayNames(), getTraitDisplayName() (+14 more)
...
Cohesion: 0.10
Nodes (33): ANCESTRY_TRANSLATIONS, BACKGROUND_TRANSLATIONS, CLASS_TRANSLATIONS, getStoredLocale(), getTranslationCoverage(), I18nContext, I18nProvider(), I18nValue (+25 more)
...
Cohesion: 0.25
Nodes (4): ClientInputError, PathbuilderHandler, PayloadTooLargeError, Pathbuilder 2e Local - Servidor HTTP e API de Personagens Executa um servidor…
...
### Community 68 - "responsive-view.test.ts"
Cohesion: 0.46
...
### Community 83 - "_make_id"
Cohesion: 0.03
Nodes (126): _extract_js_rationale(), _add_doc_ref(), _add_rationale(), _extract_python_rationale(), _add_rationale(), _get_docstring(), walk_docstrings(), _import_php() (+118 more)
...
### Community 165 - "extract.py"
Cohesion: 0.03
Nodes (144): _augment_js_reexport_edges(), _emit_rescued_import(), extract_astro(), extract_svelte(), extract_vue(), _import_js(), _import_lua(), _import_python() (+136 more)
...
Cohesion: 0.83
Nodes (3): loadEngine(), loadRestCharacter(), read()
...
### Community 170 - "audit-local-locale-usage.cjs"
Cohesion: 0.33
...
Cohesion: 0.05
Nodes (58): AccountViewState, listeners, snapshot, subscribe(), useAccountViewState(), LegacyRecord, GoogleDrivePdf, googleDrivePdfs (+50 more)

### Community 173 - "graphify/export.py"
Cohesion: 0.03
Nodes (86): _node_community_map(), Invert communities dict: node_id -> community_id., _adopt_pre_manifest_notes(), attach_hyperedges(), _cap_filename(), _cypher_escape(), _cypher_label(), _dedup_node_filenames() (+78 more)
...
Cohesion: 0.09
Nodes (24): ActionDefinition, PF2E_ACTIONS_CATALOG, RAW_ACTIONS, locales, GUNS_GEARS_EQUIPMENT, ItemDefinition, PF2E_ITEMS_CATALOG, RAW_ITEMS (+16 more)
...
Cohesion: 0.05
Nodes (79): apply(), _generate(), main(), Produce one shot. Runs on a worker thread; never raises., main(), main(), mint3d(), api_key() (+71 more)
...
Cohesion: 0.07
Nodes (71): attach_graph_impact(), bold(), build_community_labels(), _c(), _ci_icon(), _classify(), cmd_prs(), compute_pr_impact() (+63 more)
...
Cohesion: 0.04
Nodes (60): distinct_repo_tags(), prefix_graph_for_global(), prune_repo_from_graph(), Return a copy of G with all node IDs prefixed with repo_tag::. Labels are…, Return a unique, human-meaningful repo tag per input graph for merge-graphs.…, Remove all nodes tagged with repo_tag from G in-place. Returns count removed., _clone_repo(), _default_graph_path() (+52 more)
...
Cohesion: 0.05
Nodes (59): _import_csharp(), _import_kotlin(), _bash_assignment_base(), _bash_source_suffix(), extract_bash(), add_edge(), add_node(), _bash_call_in_command_allowed() (+51 more)

### Community 191 - "extractors/base.py"
Cohesion: 0.06
Nodes (58): make_id(), Single source of truth for node-ID normalization. Three independent producers…, Build a canonical node ID from one or more name parts. Parts are joined with…, _add_edge(), _add_node(), _detect_package_from_args(), _emit_server(), extract_mcp_config() (+50 more)

### Community 192 - "ingest.py"
Cohesion: 0.05
Nodes (56): _detect_url_type(), _download_binary(), _fetch_arxiv(), _fetch_html(), _fetch_tweet(), _fetch_webpage(), _html_to_markdown(), ingest() (+48 more)
...
### Community 198 - "_ImageRef"
Cohesion: 0.06
Nodes (52): _anthropic_content(), _anthropic_response_text(), _azure_client(), _backend_pkg_hint(), _bedrock_content(), _bedrock_response_text(), _call_azure(), _call_bedrock() (+44 more)

### Community 199 - "taste-application/scripts/taste/timeline.py"
Cohesion: 0.08
Nodes (51): build_clips(), collect_media(), detect_resolution(), load_resolve_module(), main(), Cadence, Path, StylePack (+43 more)

### Community 200 - "extract_corpus_parallel"
Cohesion: 0.07
Nodes (49): _best_cut(), expand_oversized_files(), FileSlice, is_splittable_text(), _pdf_text(), Path, Intra-file slicing for oversized text documents (#1369). The extraction packer…, A contiguous ``[start, end)`` character range of a splittable text file.… (+41 more)

### Community 201 - "install.py"
Cohesion: 0.08
Nodes (49): _agents_install(), _agents_platform_install(), _always_on(), _canonical_platform(), claude_install(), codebuddy_install(), _copy_skill_file(), _cursor_install() (+41 more)
...
Cohesion: 0.10
Nodes (6): build_application_bundle(), Validate resident evidence and return a new deterministic, offline bundle., Recheck all files, derived state and exact flags; no mutation or execution., validate_application_bundle(), ApplicationBundleTests, Synthetic, local-only acceptance tests for preserving an existing edit.
...
### Community 210 - "llm.py"
Cohesion: 0.06
Nodes (42): _balanced_object(), _bind_node_evidence(), _claude_cli_available(), _claude_cli_envelope(), _claude_cli_error(), _community_label_lines(), _custom_providers_path(), _envelope_after_preamble() (+34 more)
...
### Community 230 - "validate_assets"
Cohesion: 0.16
Nodes (17): _assets(), _bundle(), _fingerprint(), ingest_assets(), _load(), _path(), _provenance(), Any (+9 more)
...
Cohesion: 0.14
Nodes (22): ContractError, _is_finite_real(), Any, Path, Fail-closed validation for multimodal TasteForge artifacts., Require complete, semantically distinct numbered genre specs., The dry-run bundle is incomplete or has lost taste specificity., Require every declared rule to cite immutable, timestamped evidence. (+14 more)
...
Cohesion: 0.08
Nodes (32): backend_detection_env_vars(), _backend_env_keys(), _backend_supports_vision(), _bedrock_inference_config(), _call_llm(), _default_model_for_backend(), detect_backend(), extract_files_direct() (+24 more)
...
Cohesion: 0.07
Nodes (4): transform_stream(), Optional local media tools; dependencies are loaded only by the selected tool., MediaUtilitiesTests, skipUnless
...
### Community 269 - "forge"
Cohesion: 0.11
Nodes (27): forge(), main(), Path, Final stage: material in, finished video out. python forge.py --genre…, Refuse to replace either a viewing copy or any part of its handoff., validate_output(), _command(), main() (+19 more)
...
### Community 273 - "ValueError"
Cohesion: 0.24
Nodes (29): _artifact(), _binding(), _candidates(), _canonical(), _check_clip(), _digest(), _identity(), _inserts() (+21 more)
...
Cohesion: 0.12
Nodes (22): Cadence, detect(), keyframe_timestamps(), load(), merge(), plan_takes(), Path, quantize_gen_duration() (+14 more)

### Community 281 - "StrictApplyTests"
Cohesion: 0.11
...
Cohesion: 0.24
Nodes (23): CampaignsPage(), addCharacterToCampaign(), addSessionLog(), Campaign, CampaignSession, Combatant, deleteCampaign(), getCampaign() (+15 more)
...
Cohesion: 0.11
Nodes (24): _antigravity_finalize(), _antigravity_install(), _devin_rules_uninstall(), _kilo_uninstall(), _kilo_uninstall_global(), _platform_skill_destination(), Write Antigravity's always-on layer next to an installed skill. Injects the…, Install graphify for Google Antigravity (global skill + .agents/rules +… (+16 more)
...
Cohesion: 0.14
Nodes (21): _build_effect_recipe(), _canonical_bytes(), _finite_real(), _hash_descriptor(), MediaToolUnavailable, parse_feature_output(), probe_media(), _prompt() (+13 more)

### Community 356 - "CliTests"
Cohesion: 0.17
...
### Community 362 - "Path"
Cohesion: 0.13
Nodes (23): _agents_platform_uninstall(), _agents_uninstall(), _amp_uninstall(), _install_kilo_plugin(), _kilo_config_path(), _kilo_config_write_path(), _load_json_like(), Path (+15 more)
...
### Community 402 - "extract_pdf_text"
Cohesion: 0.13
...
Cohesion: 0.15
Nodes (16): _asset_name(), _check_outputs(), Mint 3D props from a style pack, and render them back into footage. Stage 2b of…, Reject existing artifacts for this stem before any billable work., background_share(), banding_score(), _lab(), main() (+8 more)

### Community 407 - "geometry"
Cohesion: 0.18
Nodes (14): export_draft(), main(), Create an explicitly named CapCut draft from local media paths., read_concat(), geometry(), output_file(), Validation and transactional output for local media tools., main() (+6 more)
...
### Community 415 - "_install_claude_hook"
Cohesion: 0.16
...
### Community 422 - "tasteforge/resolve.py"
Cohesion: 0.18
...
### Community 429 - "check_graph_file_size_cap"
Cohesion: 0.19
Nodes (17): _is_file_node_label(), Whether *label* is a file node's label for *source_file* — the bare basename,…, check_graph_file_size_cap(), _max_graph_file_bytes(), Reject *path* if its size exceeds the configured graph-file cap. Protects…, Return the graph.json size cap in bytes. Honors the…, build_tree(), _ensure_dir() (+9 more)
...
### Community 449 - "_extract_with_adaptive_retry"
Cohesion: 0.15
...
### Community 473 - "link_cross_repo_member_calls"
Cohesion: 0.20
...
Cohesion: 0.28
Nodes (14): extract_ocaml(), add_edge(), add_node(), emit_type(), last_name(), line_of(), named_child_text(), path_root_module() (+6 more)
...
### Community 502 - "_SafeOutput"
Cohesion: 0.19
Nodes (7): Path, RuntimeError, Descriptor-bound output tree with no-follow traversal and atomic writes., Validate every known intermediate before the first artifact write., resolve_input(), _SafeOutput, _sha256()
...
### Community 504 - "admin.ts"
Cohesion: 0.21
Nodes (12): isSupabaseConfigured, supabase, SUPABASE_PROJECT_KEY, SUPABASE_PROJECT_URL, supabasePublishableKey, supabaseUrl, AccessLogEntry, AdminDashboardMetrics (+4 more)
...
### Community 533 - "workflow_graphs.py"
Cohesion: 0.25
Nodes (13): compile_application_input(), https_url(), load_graph(), main(), nonempty(), prepare_distillation_input(), Compile inputs for clone-ready Fal graphs entirely offline; never submit jobs., Source video contains the user's content; taste affects the HOW section. (+5 more)
...
Cohesion: 0.26
Nodes (11): extract_terraform(), _add_edge(), _add_node(), _block_parts(), _collect_refs(), _label_text(), _read(), _ref_address() (+3 more)
...
### Community 567 - "scripts/apply.py"
Cohesion: 0.18
Nodes (10): build_prompt(), GradeStats, Path, The one sentence that tells the model what shape of clip to produce. A take…, One planned shot, plus whatever the run produced for it., Generate new video from a style pack. Stage 3 of taste-forge. The pack supplies…, Assemble one shot prompt: structure and motion only, then brief, then avoid.…, ShotPlan (+2 more)
...
### Community 591 - "extract_json"
Cohesion: 0.27
Nodes (11): extract_json(), add_edge(), add_node(), _key_text(), _val_node(), walk_object(), _is_config_json(), Path (+3 more)
...
### Community 939 - "validate_graph_path"
Cohesion: 0.67
...
### Community 975 - "_subsample_idx"
Cohesion: 0.67
Nodes (3): slice, Stride that keeps at most ``cap`` samples - enough for a stable mean., _subsample_idx()

## Knowledge Gaps
- **7137 isolated node(s):** `When to Use`, `Core Concepts`, `Step 1: Identify the Component Role`, `Step 2: Define Perceivable Attributes`, `Step 3: Implement Operable Controls` (+7132 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 9834 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **115 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_semantic_reference_edge()` connect `extract_objc` to `ValueError`, `_read_text`, `extract.py`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `extract_commonlisp()` connect `extract_commonlisp` to `_make_id`, `extract.py`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `check_graph_file_size_cap()` connect `check_graph_file_size_cap` to `load_graph`, `diagnostics.py`, `validate_graph_path`, `graphify/export.py`, `callflow_html.py`, `ValueError`, `graphify/cli.py`, `edge_data`, `serve.py`, `build.py`, `_build_server`, `dispatch_command`, `security.py`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Are the 127 inferred relationships involving `ValueError` (e.g. with `_fetch_import_url()` and `_remove_project_storage()`) actually correct?**
...
- **What connects `When to Use`, `Core Concepts`, `Step 1: Identify the Component Role` to the rest of the system?**

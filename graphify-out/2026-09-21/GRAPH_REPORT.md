...
## Corpus Check
- 1272 files · ~15,377,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16843 nodes · 24875 edges · 1070 communities (928 shown, 127 thin omitted)
...
## Communities (1070 total, 127 thin omitted)
...
Cohesion: 0.12
Nodes (33): assertSafeCharacterDocument, buildCharacterRevisionHistory(), cacheLocalCharacter(), CHARACTER_RULESETS_BY_SYSTEM, CharacterRevision, CharacterRuleset, CharacterSaveConflictInfo, characterTimestamp() (+25 more)
...
Cohesion: 0.05
Nodes (60): react-dom, getSystemActionItems(), DND_CONDITIONS, getSystemConditionItems(), getSystemRuleItems(), RuleDefinition, RULES, SYSTEM_RULE_DEFINITIONS (+52 more)

### Community 10 - "PortalPages.tsx"
Cohesion: 0.04
Nodes (103): AccountViewState, listeners, snapshot, subscribe(), useAccountViewState(), LegacyRecord, CoreCatalogEntry, GoogleDrivePdf (+95 more)
...
Cohesion: 0.09
Nodes (55): pdf-lib, fixture, OSE_CLASSES, OseClass, OseClassAcrobatSkills, OseClassProgression, OseClassThiefSkills, OseCombatCategory (+47 more)
...
Cohesion: 0.07
Nodes (69): _get_backend_api_key(), Return the first configured API key for backend, or an empty string., attach_graph_impact(), bold(), build_community_labels(), _c(), _ci_icon(), _classify() (+61 more)
...
Cohesion: 0.10
Nodes (27): _estimate_tokens(), _hr(), Graph, _query_subgraph_tokens(), Token-reduction benchmark - measures how much context graphify saves vs naive…, Return unicode_char if stdout can encode it, else ascii_fallback. Windows…, Horizontal rule that survives non-UTF-8 stdout (e.g. Windows cp1252 console)., Run BFS from best-matching nodes and return estimated tokens in the subgraph… (+19 more)
...
### Community 68 - "vitest"
Cohesion: 0.05
Nodes (13): vitest, loadBackgroundBoostConstraints(), loadCatalogMerger(), loadCollectionRemover(), read(), loadEngine(), loadRestCharacter(), read() (+5 more)
...
Cohesion: 0.03
Nodes (146): _augment_js_reexport_edges(), _emit_rescued_import(), extract_astro(), extract_svelte(), extract_vue(), _import_js(), _import_lua(), _import_python() (+138 more)
...
Cohesion: 0.04
Nodes (84): equipmentCategory(), getCoreCompendiumEntries(), makeEntry(), sourceBooks, DND5E_BACKGROUND_SOURCE_BOOK, DND5E_BACKGROUNDS, Dnd5eBackground, DND5E_CLASSES (+76 more)

### Community 173 - "extract_pdf_text"
Cohesion: 0.13
...
Cohesion: 0.04
Nodes (57): {fontFamily}, react, @testing-library/react, ActionDefinition, PF2E_ACTIONS_CATALOG, RAW_ACTIONS, locales, GUNS_GEARS_EQUIPMENT (+49 more)

### Community 180 - "watch.py"
Cohesion: 0.05
Nodes (69): dedupe_nodes(), disambiguate_file_labels_in_nodes(), Relabel colliding-basename file nodes on a raw node-dict list, in place…, Collapse nodes sharing an ``id``, last-writer-wins on attributes. Mirrors what…, _apply_resource_limits(), _batch_needs_llm_flag(), _batch_triggers_rebuild(), _canonical_graph_for_compare() (+61 more)
...
Cohesion: 0.04
Nodes (87): default_graph_json(), Default ``graph.json`` path under the configured output dir. The package-wide…, Strip control characters and cap length. Safe for embedding in JSON data…, sanitize_label(), _ApiKeyMiddleware, _bfs(), _build_http_app(), _tool_get_community() (+79 more)
...
Cohesion: 0.05
Nodes (49): _adopt_pre_manifest_notes(), attach_hyperedges(), _cap_filename(), _cypher_escape(), _cypher_label(), _dedup_node_filenames(), _git_head(), _is_graphify_note() (+41 more)

### Community 185 - "_is_ignored"
Cohesion: 0.14
...
### Community 187 - "link_cross_repo_member_calls"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (75): ABILITIES, CoreCharacterCreatorModal(), CoreCharacterCreatorModalProps, reconcileCoreSkillProficiencies(), reconcileT20DeityDependentFeatIds(), CORE_ABILITY_LABELS, CoreCharacterSheet(), CoreCharacterSheetProps (+67 more)

### Community 192 - "tasteforge/resolve.py"
Cohesion: 0.16
Nodes (15): Compatibility import for the canonical ECC Resolve adapter. Alias the module…, allocate_placements(), apply_placements(), _base_snapshot(), _fps(), _integer(), _items(), _path() (+7 more)
...
Cohesion: 0.20
Nodes (29): AccountPortal(), AuthMode, updateAccountViewState(), LibraryPage(), buildUserProfileFromAuth(), changePassword(), deleteAccount(), ensureSupabaseAuthSubscription() (+21 more)
...
Cohesion: 0.12
Nodes (13): DND5E_SUBCLASS_CHOICES, DND5E_SUBCLASS_FEATURES, DND5E_SUBCLASS_LEVELS, DND5E_SUBCLASSES_BASE, Dnd5eClassChoice, Dnd5eSubclass, Dnd5eSubclassBase, Dnd5eSubclassChoice (+5 more)
...
Cohesion: 0.10
Nodes (29): extract_pascal(), add_edge(), add_node(), _emit_or_report(), _proc_name(), _read(), _extract_pascal_regex(), walk() (+21 more)
...
### Community 228 - "grade"
Cohesion: 0.09
Nodes (38): classify_events(), _parse_classification(), Classify tool calls against compliance steps using LLM., Classify which tool calls match which compliance steps. Returns {step_id:…, Parse LLM classification output into {step_id: [event_indices]}., _check_temporal_order(), ComplianceResult, grade() (+30 more)
...
Cohesion: 0.02
Nodes (134): print_benchmark(), Print a human-readable benchmark report., Measure token reduction: corpus tokens vs graphify query tokens. Args:…, run_benchmark(), dedupe_edges(), distinct_repo_tags(), edge_datas(), prefix_graph_for_global() (+126 more)
...
Cohesion: 0.12
Nodes (25): main(), api_key(), _cache_key(), download(), enable_dry_run(), is_dry_run(), _is_transient(), MissingKeyError (+17 more)
...
### Community 405 - "patch"
Cohesion: 0.22
Nodes (4): write_test has before_step=write_impl, but test is written AFTER impl., TestGradeCompliant, TestGradeNoncompliant, patch
...
Cohesion: 0.08
Nodes (30): Path, Run scenarios via claude -p and parse tool calls from stream-json output., Create sandbox directory and run setup commands., Execute a scenario and extract tool calls from stream-json output., Sanitize scenario ID and ensure path stays within sandbox base., run_scenario(), _safe_sandbox_dir(), ScenarioRun (+22 more)
...
Cohesion: 0.09
Nodes (30): compose(), extract_frame(), _fal(), FalError, first_url(), image_to_3d(), images_to_video(), merge_videos() (+22 more)
...
Cohesion: 0.26
Nodes (6): parse_trace(), Parse a JSONL observation trace file into sorted events., compliant_trace(), noncompliant_trace(), Path, TestParseTrace
...
### Community 534 - "vlm_describe"
Cohesion: 0.33
Nodes (6): Best-effort extraction of the text body from an LLM/VLM response., Describe reference stills. Returns the model's raw text output. ``schema_hint``…, Build a stub object with the same keys and types as ``schema``., _stub_from_schema(), _text_of(), vlm_describe()
...
Cohesion: 0.33
Nodes (7): _digest(), parse_urls(), walk(), Any, Collect every URL in a response, depth-first, in order. Response envelopes…, A plausible, deterministic response for ``endpoint``. Deterministic because it…, _stub()
...
Cohesion: 0.03
Nodes (110): _extract_js_rationale(), _add_doc_ref(), _import_php(), _import_scala(), _import_swift(), Emit module-level ``imports`` edges and report the imported modules. A Swift…, Post-pass: extract rationale comments and doc references from JS/TS source.…, extract_apex() (+102 more)
...
### Community 844 - "audit-supabase-character-sync.cjs"
Cohesion: 0.40
...
### Community 1044 - "_mock_compliant_classification"
Cohesion: 0.33
Nodes (4): _mock_compliant_classification(), _mock_noncompliant_classification(), Simulate LLM correctly classifying a compliant trace., Simulate LLM classifying a noncompliant trace (impl before test).
...
### Community 1051 - "reference_to_video"
Cohesion: 0.50
Nodes (4): quantize_duration(), Generate one shot from a style-reference image. Returns the video URL.…, Round a planned shot length onto the video model's supported grid., reference_to_video()
...
## Knowledge Gaps
- **7869 isolated node(s):** `1. Visão geral do projeto`, `2.1 Crítico`, `2.2 Testes com falha / risco de regressão`, `2.3 Inconsistências de dados`, `2.4 OSE Classic — fluxo incompleto (maior gap)` (+7864 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 10617 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **127 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `dispatch_command()` connect `graphify/cli.py` to `scope_semantic_result`, `write_callflow_html`, `Path`, `cache.py`, `Path`, `cluster.py`, `save_semantic_cache`, `_build_server`, `querylog.py`, `load_cached`, `watch.py`, `serve.py`, `graphify/export.py`, `link_cross_repo_member_calls`, `graphify/__main__.py`, `affected.py`, `diagnostics.py`, `paths.py`, `semantic_cleanup.py`, `reflect.py`, `detect`, `ingest.py`, `analyze.py`, `llm.py`, `hooks.py`, `introspect_cargo`, `save_manifest`, `build.py`, `build_tree`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `_file_stem()` connect `_make_id` to `extract_commonlisp`, `extract_bash`, `_extract_python_rationale`, `extract_fortran`, `Path`, `_read_text`, `extract_rust`, `extract_dm`, `symbol_resolution.py`, `extract_xaml`, `sanitize_metadata`, `extract_go`, `mcp_ingest.py`, `extract_elixir`, `extract.py`, `extract_objc`, `extract_robot`, `extract_pascal`, `verilog.py`, `extract_ocaml`, `build.py`, `extract_sql`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `_normalize_hyperedge_members()` connect `semantic_cleanup.py` to `build.py`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
...
- **What connects `1. Visão geral do projeto`, `2.1 Crítico`, `2.2 Testes com falha / risco de regressão` to the rest of the system?**
  _7869 weakly-connected nodes found - possible documentation gaps or missing edges._

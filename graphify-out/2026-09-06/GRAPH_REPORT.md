# Graph Report - pathbuilder2e_local  (2026-09-06)

## Corpus Check
- 225 files · ~3,178,965 words
...
## Knowledge Gaps
- **936 isolated node(s):** `Objetivo integral do usuário`, `Requisitos explícitos a preservar`, `Estado confirmado nesta sessão`, `Próxima sequência obrigatória para o próximo agente`, `Regra de atualização contínua` (+931 more)
...
- **Why does `PathbuilderApp` connect `PathbuilderApp` to `.renderAll`, `.animateDiceRoll`, `.applyPickerSelection`, `escapeHtml`, `.renderModalLeftList`, `.loadInitialCharacter`?**
...
- **What connects `Objetivo integral do usuário`, `Requisitos explícitos a preservar`, `Estado confirmado nesta sessão` to the rest of the system?**
